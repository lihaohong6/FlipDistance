...
#ifndef FLIPDISTANCE_FLIP_DISTANCE_ORIGINAL_H
#define FLIPDISTANCE_FLIP_DISTANCE_ORIGINAL_H
...
class FlipDistanceOriginal : public FlipDistance {
private:
    std::vector<Edge> oLex;
    unsigned int flips = 0;

public:
    FlipDistanceOriginal(TriangulatedGraph start, TriangulatedGraph end)
...
#endif //FLIPDISTANCE_FLIP_DISTANCE_ORIGINAL_H
